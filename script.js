...
// Function waktu penghitung mundur agar berjalan sesuai perintah
const second = 1000,
  minute = second * 60,
  hour = minute * 60,
  day = hour * 24;
let countDown = new Date('September 27, 2022 00:00:00').getTime(),
...
new TypeIt("#teks1", {
  strings: ["Assalamualaikum Wr. Wb", " ", "Saya Surya pada hari ini Selasa, 27 September 2022 dengan sepenuh hati mengucapkan", " ", "<b>Selamat Ulang Tahun Yang ke 16</b>", " ", "Kepada Desy Ratra Sari, semoga kamu panjang umur, dan bahagia selalu. Aamiin. Sekian surat pernyataan dari saya", , " ", "Wassalamualakaikum Wr. Wb", " ", "- Surya :)"],
  startDelay: 4000,
  speed: 75,
